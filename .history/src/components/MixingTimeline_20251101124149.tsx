      ...
      <div className="relative h-24 bg-gray-900/50 rounded-lg p-3 border border-gray-700">
        ...
        <div className="absolute top-8 left-3 right-3">
          <div className="relative h-8 bg-blue-600/80 rounded border-2 border-blue-400 shadow-lg">
            ...
            {fadeIn > 0 && (
              <div 
                className="absolute left-0 top-0 bottom-0 bg-blue-900/60 rounded-l border-r border-blue-300/50"
                style={{ 
                  width: `${(fadeIn / ttsDuration) * 100}%`,
            ...
            {fadeOut > 0 && (
              <div 
                className="absolute right-0 top-0 bottom-0 bg-blue-900/60 rounded-r border-l border-blue-300/50"
                style={{ 
                  width: `${(fadeOut / ttsDuration) * 100}%`,
