      ...
      <div className="container mx-auto px-4">
        ...
        {isOpen && (
          <div className="md:hidden py-4 space-y-4 border-t border-border">
            <Link to="/" className="block py-2 text-sm font-medium hover:text-primary transition-colors" onClick={handleMenuClick}>
              홈
            </Link>
            {isAuthenticated ? (
              <>
              ...
              <>
                <a href="#features" className="block py-2 text-sm font-medium hover:text-primary transition-colors" onClick={handleMenuClick}>
                  기능
                </a>
                <a href="#generator" className="block py-2 text-sm font-medium hover:text-primary transition-colors" onClick={handleMenuClick}>
                  음성 생성
                </a>
                <a href="#schedule" className="block py-2 text-sm font-medium hover:text-primary transition-colors" onClick={handleMenuClick}>
                  스케줄
                </a>
              </>
            )}
