          ...
          <div className="md:hidden py-4 space-y-4 border-t border-border">
            {isAuthenticated ? (
              <>
                ...
                <Link to="/voice-generator" className="block py-2 text-sm font-medium hover:text-primary transition-colors">
                  음성 생성
                </Link>
                <Link to="/advanced-voice" className="block py-2 text-sm font-medium hover:text-primary transition-colors">
                  고급 음성
                </Link>
                <Link to="/voice-cloning" className="block py-2 text-sm font-medium hover:text-primary transition-colors">
                  보이스 클로닝
                </Link>
                <Link to="/schedule" className="block py-2 text-sm font-medium hover:text-primary transition-colors">
                  스케줄
                </Link>
                <Link to="/analytics" className="block py-2 text-sm font-medium hover:text-primary transition-colors">
                  통계
                </Link>
              ...
              <>
                ...
                <a href="#generator" className="block py-2 text-sm font-medium hover:text-primary transition-colors">
                  음성 생성
                </a>
                <a href="#schedule" className="block py-2 text-sm font-medium hover:text-primary transition-colors">
                  스케줄
                </a>
