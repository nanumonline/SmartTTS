      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/" className="hover:text-primary transition-colors">회사 소개</Link></li>
              <li><Link to="/pricing" className="hover:text-primary transition-colors">요금제</Link></li>
              <li><a href="mailto:june@nanumlab.com" className="hover:text-primary transition-colors">고객 지원</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:june@nanumlab.com" className="hover:text-primary transition-colors">june@nanumlab.com</a>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <a href="tel:033-912-1004" className="hover:text-primary transition-colors">033-912-1004</a>
              </li>
              <li className="flex items-center gap-2">
