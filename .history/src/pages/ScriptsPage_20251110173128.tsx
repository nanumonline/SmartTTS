              ...
              <CardContent className="p-0">
                <div className="divide-y">
                  {paginatedScripts.map((script) => (
                    <div
                      key={script.id}
                      className="p-4 hover:bg-muted/50 transition-colors min-h-[180px] flex flex-col"
                    >
                      {editingId === script.id ? (
                        // 편집 모드
                        ...
                        <div className="flex flex-col flex-1 min-h-0">
                          ...
                          <p className="text-sm text-foreground mb-3 whitespace-pre-wrap flex-1 line-clamp-4 overflow-hidden">
                            {script.text}
                          </p>
                          <div className="flex items-center gap-2 mt-auto">
                            <Button
