                            ...
                            <div className="space-y-2">
                              <div className="flex items-center justify-between">
                                ...
                                <Button
                                  ...
                                  className="text-xs h-7"
                                  onClick={() => {
                                    // 직접작성의 기본문구를 OpenAI 프롬프트로 이전
                                    const baseText = customText.trim() || purposeMetaForSelected.optimizedPrompt;
                                    const instruction = purposeMetaForSelected.optimizedPrompt;
                                    // 기본문구 + 지침 형식으로 설정
                                    ...
                                    toast({
                                      title: "지침 적용 완료",
                                      description: "기본 프롬프트가 OpenAI 작성 탭으로 이동되었고, 지침이 추가되었습니다.",
                                    });
                                  }}
                                >
                                  지침으로 추가
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <Button
                                    ...
                                    onClick={() => {
                                      ...
                                      toast({
                                        title: "지침 적용 완료",
                                        description: "공공기관 방송지침이 OpenAI 작성 탭으로 이동되었고, 지침이 추가되었습니다.",
                                      });
                                    }}
                                  >
                                    지침으로 추가
