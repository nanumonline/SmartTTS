                                ...
                                <Button
                                  ...
                                  onClick={async () => {
                                    ...
                                    try {
                                      ...
                                      // 지침을 프롬프트로 사용하여 메시지 생성
                                      const prompt = `${purposeLabel} 목적에 맞는 방송문을 작성하세요. ${instruction}`;
                                      ...
                                      toast({
                                        title: "지침 적용 및 생성 완료",
                                        description: "기본 프롬프트가 적용되어 메시지가 생성되었습니다.",
                                      });
                                    } catch (e: any) {
                                      toast({
                                        title: "메시지 생성 실패",
                                        description: e?.message || "메시지 생성 중 오류가 발생했습니다.",
                                        variant: "destructive",
                                      });
                                    } finally {
                                  ...
                                  <Button
                                    ...
                                    onClick={async () => {
                                      ...
                                      try {
                                        setIsLoadingAI(true);
                                        const purposeLabel = purposeMetaForSelected?.label || "공지";
                                        // 공공기관 방송지침을 프롬프트로 사용하여 메시지 생성
                                        const prompt = `${purposeLabel} 목적에 맞는 방송문을 작성하세요. ${guidelinesText}`;
                                        const fullPrompt = `${prompt}\n\n${optimizedPromptWithGuidelines}`;
                                        const out = await generateWithOpenAI(fullPrompt);
                                        setCustomText(out);
                                        ...
                                        toast({
                                          title: "지침 적용 및 생성 완료",
                                          description: "공공기관 방송지침이 적용되어 메시지가 생성되었습니다.",
                                        });
                                      } catch (e: any) {
                                        toast({
                                          title: "메시지 생성 실패",
