                  ...
                  <Select value={selectedVoice} onValueChange={(value) => {
                    ...
                    <SelectContent>
                      ...
                      {availableVoices.length > 0 ? (
                        <>
                          <div className="px-2 py-1 text-[11px] text-muted-foreground grid gap-2 [grid-template-columns:56px_72px_minmax(140px,1fr)_96px_minmax(160px,1fr)]">
                            <div>즐겨찾기</div>
                            <div>성별</div>
                            <div>이름</div>
                            <div>국가</div>
                            ...
                            .map((voice: any) => {
                              ...
                              return (
                                <SelectItem key={voice.voice_id} value={voice.voice_id}>
                                  <div className="grid gap-2 items-center [grid-template-columns:56px_72px_minmax(140px,1fr)_96px_minmax(160px,1fr)]">
