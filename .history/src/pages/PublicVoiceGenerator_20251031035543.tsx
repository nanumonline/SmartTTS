...
const PublicVoiceGenerator = () => {
  ...
  const languageOptions = [
    "ko", "en", "ja", "zh", "es", "fr", "de", "it", "pt", "ru", "ar", "hi", "id", "tr"
  ];
  const styleOptions = [
    "neutral", "happy", "sad", "angry", "calm", "friendly", "professional", "excited", "serious", "whisper", "shout", "formal", "casual", "narrative"
  ];
  const genderOptions = ["male", "female", "neutral", "child_male", "child_female"];
  const useCaseOptions = [
    "announcement", "public-service", "broadcast", "education", "marketing", "narration", "assistant", "news", "audiobook", "gaming", "advertisement", "telephone"
  ];
