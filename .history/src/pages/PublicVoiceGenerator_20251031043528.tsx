  ...
  const handleGenerateVoice = async () => {
    ...
    try {
      ...
      if (proxyResponse?.ok) {
        ...
        let errorMessage = `프록시 오류 (${proxyResponse.status})`;
        try {
        ...
        toast({ title: "❌ 음성 생성 실패", description: errorMessage, variant: "destructive" });
      }
