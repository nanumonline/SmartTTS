              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 p-3 bg-primary/10 rounded-lg border border-primary/20">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {purposeMeta?.description || "일반 공지사항 안내"}
                  </span>
                </div>
                        ...
                        <AccordionContent>
                          <div className="space-y-2">
                            <ul className="space-y-2 text-xs">
                              {(customChecklist || purposeMeta.checklist || []).map((item, idx) => (
                                    ...
                                    <Button
                                      ...
                                      onClick={() => {
                                        if (confirm("이 항목을 삭제하시겠습니까?")) {
                                          const currentList = customChecklist || purposeMeta.checklist || [];
                                ...
                                <Input
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.key === "Enter" && newChecklistItem.trim()) {
                                      const currentList = customChecklist || purposeMeta.checklist || [];
                                      const newList = [...currentList, newChecklistItem.trim()];
                                      saveCustomChecklist(newList);
                                      setNewChecklistItem("");
                                      toast({
                                        title: "추가 완료",
                          ...
                          <div className="space-y-2">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                toast({
                                  title: "지침 추가 완료",
                                  description: "OpenAI 작성 탭으로 이동하여 지침이 적용되었습니다.",
                                });
                              }}
                            >
                              지침으로 추가
