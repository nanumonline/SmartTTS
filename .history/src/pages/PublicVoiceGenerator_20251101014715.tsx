                    ...
                    return (
                      <div key={entry.id} className="rounded-lg border border-border bg-muted/20 p-3 grid gap-3 md:grid-cols-[160px_minmax(0,1fr)_160px_200px] items-center">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-muted-foreground">길이: {entry.duration ? `${entry.duration.toFixed(2)}초` : "-"}</div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Button size="sm" variant="outline" disabled title="보이스 클로닝 기능 준비 중">클로닝</Button>
                          <Button size="sm" variant="outline" disabled title="믹싱 기능 준비 중">믹싱</Button>
                          <Button size="sm" variant="outline" disabled title="예약 전송 기능 준비 중">예약</Button>
                        </div>
                      </div>
                    );
                  })}
