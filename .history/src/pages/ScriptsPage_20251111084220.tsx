                      ...
                      <div className="p-4 bg-muted/50 rounded-lg border border-border space-y-2">
                        {script.purpose && (
                          <div className="flex items-start gap-2">
                            ...
                            <Badge variant="outline" className="text-xs">{purposeOptions.find(p => p.value === script.purpose)?.label || script.purpose}</Badge>
                          </div>
                        )}
                        {script.text && (
                          <div className="flex items-start gap-2">
                        ...
                        {script.created_at && (
                          <div className="flex items-start gap-2">
                            ...
                            <span className="text-sm flex-1">{formatDate(script.created_at)}</span>
                          </div>
                        )}
                      </div>
                    </div>
