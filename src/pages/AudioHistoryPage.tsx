                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1 text-sm text-muted-foreground">
                        ...
                        {!isMixedAudio(gen) && <span>{getVoiceDisplayNameKo(gen.voiceName, gen.voiceId, (gen as any).name_ko)}</span>}
                        {gen.duration && (
                      ...
                      <div className="p-4 bg-muted/50 rounded-lg border border-border space-y-2">
                        ...
                        {entry.voiceName && (
                          <div className="flex items-start gap-2">
                            ...
                            <span className="text-sm flex-1">{getVoiceDisplayNameKo(entry.voiceName, entry.voiceId, (entry as any).name_ko)}</span>
                          </div>
                        )}
                        {entry.duration && (
                          <div className="flex items-start gap-2">
                  ...
                  <>
                    {isMixedAudio(localSaveDialog.entry) ? (
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">{getVoiceDisplayNameKo(localSaveDialog.entry.voiceName, localSaveDialog.entry.voiceId, (localSaveDialog.entry as any).name_ko)}</span>
                      </div>
                    ) : null}
                  </>
                )}
