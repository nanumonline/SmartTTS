        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-primary transition-colors">음성 생성</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">보이스 클로닝</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">스케줄 관리</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">API 연동</a></li>
            </ul>
          </div>
